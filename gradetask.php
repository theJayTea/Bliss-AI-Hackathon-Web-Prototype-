...
$tasksubmitid = $_GET["id"];
if(isset($_SESSION['id'])) {
    if(isset($_POST['submit'])) {
        $result = mysqli_query($conn, "SELECT * FROM task_submit WHERE tasksubmitid = '$tasksubmitid'");
        ...
        $marksacheived = $_POST['markacheived'];

        mysqli_query($conn, "INSERT INTO task_graded VALUES('', '$taskname', '$studentid', '$studentname', '$tutorid', '$tutorname', '$questions', '$deadline', '$totalmarks', '$subject', '$taskdescription', '$response', '$marksacheived', '$feedback')");
        mysqli_query($conn, "DELETE FROM task_submit WHERE tasksubmitid = $tasksubmitid");
...
<html>
    ...
    <body>
      ...
      <div class="container">
        ...
        <div style="margin-left: 200px;"><h2 class="section-title__heading mb-4">
                Student Answer:</h2>
<p style='margin-bottom:150px; '> 
                <?php 

$result4 = mysqli_query($conn, "SELECT * FROM task_submit WHERE tasksubmitid = '$tasksubmitid'");
$result5 = mysqli_fetch_array($result4);
echo $result5['response'];
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-floating">
                    ...
                    <label>Feedback on Submission</label>
                  </div>
                  <div class="form-floating">
                    <input class="form-control" name="markacheived" placeholder="Leave a comment here" style="height: 100px"></input>
